...
const translations = {
  ...
  th: {
    ...
    themes: {
      ...
      sweet: "ธีมหวาน",
      broccoli: "ธีมบรอกโคลี",
      watermelon: "แตงโม",
      honey: "น้ำผึ้ง"
    },
    apps: {
      sectionTitle: "แอปและเครื่องมือ",
      sectionSubtitle: "เครื่องมือที่เป็นประโยชน์สำหรับการดูแลโภชนาการของคุณ",
      tddCalculator: {
        title: "เครื่องคำนวณ TDD",
        description: "คำนวณความต้องการแคลอรี่ประจำวันและอัตราส่วนสารอาหารที่เหมาะสม",
        ...
        lightlyActive: "ออกกำลังกายเล็กน้อย",
        moderatelyActive: "ออกกำลังกายปานกลาง",
        veryActive: "ออกกำลังกายมาก",
        extremelyActive: "ออกกำลังกายหนักมาก",
        results: {
          yourTdd: "TDD ของคุณ:",
          caloriesPerDay: "แคลอรี่ต่อวัน",
          macroRatios: "อัตราส่วนสารอาหารที่แนะนำ:",
          adjustRatios: "ปรับอัตราส่วน:",
          protein: "โปรตีน",
          carbs: "คาร์บส์",
          fat: "ไขมัน",
          goalAdjustment: "ปรับให้เหมาะกับเป้าหมายของคุณ",
          ...
          noAdjustment: "(แคลอรี่สำหรับการรักษาสภาพ)",
          waterIntake: "Recommended Water Intake:",
          mlPerDay: "ml per day",
          waterIntakeExplanation: "Based on your weight (35ml × kg)"
        }
      ...
      petGame: {
        ...
        description: "ดูแลสัตว์เลี้ยงเสมือนจริงของคุณโดยการทำตามเป้าหมายโภชนาการ",
        startGame: "เริ่มเกม",
  ...
  ja: {
    ...
    apps: {
      ...
      sectionSubtitle: "栄養管理に役立つツール",
      tddCalculator: {
        title: "TDD計算機",
        description: "1日のカロリー必要量と最適な栄養比率を計算します",
        calculateButton: "TDDを計算する",
        applyButton: "設定に適用する",
        successMessage: "設定が更新されました！",
        height: "身長",
        weight: "体重",
        age: "年齢",
        gender: "性別",
        ...
        sedentary: "座りがち",
        lightlyActive: "軽い運動",
        moderatelyActive: "適度な運動",
        veryActive: "活発な運動",
        extremelyActive: "非常に活発な運動",
        results: {
          yourTdd: "あなたのTDD:",
          ...
          baseCalories: "基本カロリー:",
          muscleGainAdjustment: "(筋肉増強のために+15%カロリー)",
