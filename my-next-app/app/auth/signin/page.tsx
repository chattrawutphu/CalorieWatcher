...
export default function SignInPage() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-12 px-4 md:px-12 bg-gradient-to-br from-purple-50 to-white">
      <motion.div 
      ...
      >
        ...
        <Card className="p-6 rounded-3xl shadow-lg border-purple-100 backdrop-blur-sm bg-white/70">
          <motion.div
            variants={container}
            initial="hidden"
            animate="show"
          ...
          >
            <motion.div variants={item} className="text-center space-y-1">
              <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">
                {t.welcome}
              </h1>
            ...
            <motion.div variants={item} className="space-y-3">
              ...
              <Button
                ...
                disabled={loading}
                className="w-full py-6 rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 transition-all shadow-md"
              >
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                {t.features.map((feature, i) => (
                  <motion.div
                    key={i}
                    className="p-2 rounded-lg bg-purple-50 border border-purple-100 text-purple-700 text-sm"
                    whileHover={{ y: -5, backgroundColor: "#E9D5FF" }}
